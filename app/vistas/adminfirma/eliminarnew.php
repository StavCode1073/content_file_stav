        ...
        <div class="box">
          <div class="box-header">
            ...
            <center>
              ...
              echo"
                  <h4><a href='".RUTA_URL."/archivosfirma/editarimgnew/".$datos['id_documento']."' class='alert-link'>Achivo</a></h4>
                <a href='".RUTA_URL."/archivosfirma/editarimgnew/".$datos['id_documento']."'>
              ...
              default:
                  ...
                  <h4><a href='".RUTA_URL."/archivosfirma/editarimgnew/".$datos['id_documento']."' class='alert-link'>Achivo</a></h4>
                  <a href='".RUTA_URL."/archivosfirma/editarimgnew/".$datos['id_documento']."'>
                    <img src='".RUTA_URL."/img/firmas/recursos/".$datos['archivo']."' class='img-responsive img-thumbnail'>
                  </a>";
              break;
              }
               ?>
      ...
      <div class="col-md-9">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form role="form"  name="fe" action="<?php echo RUTA_URL;?>/archivosfirma/eliminarnew/<?php echo $datos['id_documento']; ?>" method="post" enctype="multipart/form-data">
