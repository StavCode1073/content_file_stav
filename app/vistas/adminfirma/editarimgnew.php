...
<header id="header">
  <div class="container">
    <div class="row">
      <div class="col-md-10">
        <h1><span class="fas fa-cog" aria-hidden="true"></span> Archivos certificados<small> sección cambiar o reemplazar</small></h1>
      </div>
    </div>
  </div>
</header>
...
<section id="breadcrumb">
  <div class="container">
    <ol class="breadcrumb">
      ...
      <li class="active breadcrumb-item">Editar Imagen</li>
      ...
      <div class="col-md-9">
        ...
        <div class="panel panel-default">
          <div class="panel-heading main-color-bg">
            <h3 class="panel-title">Actulaizar o cambiar archivo</h3>
          </div>
          <div class="panel-body">
            <center>
              ...
              echo"
                ...
                <br>
                <a  title='VISUALIZAR IMAGEN' target='_Blank' href='".RUTA_URL."/img/firmas/".$datos['archivo']."'>
              ...
              default:
                  ...
                  <a title='VISUALIZAR IMAGEN'>
                    <img src='".RUTA_URL."/img/firmas/".$datos['archivo']."' class='img-responsive img-thumbnail'>
                  </a>";
              break;
              }
               ?>
            ...
            <form role="form"  name="fe" action="<?php echo RUTA_URL;?>/archivosfirma/editarimgnew/<?php echo $datos['id_documento']; ?>" method="post" enctype="multipart/form-data">
