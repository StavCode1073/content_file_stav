...
<header id="header">
  <div class="container">
    <div class="row">
      <div class="col-md-10">
        <h1><span class="fas fa-cog" aria-hidden="true"></span> Centro de recursos<small> Editar</small></h1>
      </div>
    </div>
  </div>
</header>
      ...
      <div class="col-md-9">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form role="form"  name="fe" action="<?php echo RUTA_URL;?>/recursos/editarnew/<?php echo $datos['id_documento']; ?>" method="post" enctype="multipart/form-data">
              <!--<div class="form-group">
                <label>Marca </label>
                <input type="text" name="marca" class="form-control" placeholder="Título de la página" value="<?php echo $datos['marca']; ?>" required>
              </div>-->
              <div class="form-group mb-3">
                <label>Descripción </label>
                <textarea name="descripcion" class="form-control" rows="6" placeholder="Mensaje" required><?php echo $datos['descripcion']; ?></textarea>
              </div>
              <div class="form-group mb-3">
              ...
              <input type="submit" class="btn btn-danger" value="Editar publicación">
            </form>
          </div>
          </div>
