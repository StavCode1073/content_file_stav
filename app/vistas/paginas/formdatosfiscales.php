...
<div class="container w-75 my-5">
	 ...
	 <div class="row">
	    ...
	    <div class="col">
	      	<div class="form-group">
				...
				<input type="text" tabindex="1"   name="Fecha" class="form-control" placeholder="R.F.C.: " value="" id="inputDefault">
			</div>
			<div class="form-group">
			   <label class="col-form-label mt-4" for="inputDefault">Uso de CFDI *: </label>
			   <input type="email" tabindex="3"  name="mail" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Uso de CFDI:" >
			</div>
	    </div>
	    <div class="col">
		    <div class="form-group">
					<label class="col-form-label mt-4" for="inputDefault">Tipo de persona *: </label>
					<input type="text" tabindex="2"  name="apellid" class="form-control" placeholder="Tipo de persona: " id="inputDefault" value="">
		    </div>
		   	<div class="form-group">
				<label class="col-form-label mt-4" for="inputDefault">Régimen fiscal *: </label>
				<input type="text" tabindex="4"  name="telefon" class="form-control" placeholder="Régimen fiscal: " id="inputDefault" value="">
		    </div>
	  </div>
	</div>
	<br>
    <div class="row">
	    <div class="col">
	      	<div class="form-group">
				<label class="col-form-label mt-4" for="inputDefault">Dirección fiscal *: </label>
				<input type="text" tabindex="5" name="Fecha" class="form-control" placeholder="Dirección fiscal: " value="" id="inputDefault">
			</div>
			<div class="form-group">
			   <label class="col-form-label mt-4" for="inputDefault">Código Postal *: </label>
			   <input type="email" tabindex="7" name="mail" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Código Postal:" >
			</div>
	    </div>
	    <div class="col">
		    <div class="form-group">
					<label class="col-form-label mt-4" for="inputDefault">Colonia *: </label>
					<input type="text" tabindex="6" name="apellid" class="form-control" placeholder="Colonia: " id="inputDefault" value="">
		    </div>
		   	<div class="form-group">
				<label class="col-form-label mt-4" for="inputDefault">Estado *: </label>
				<input type="text" tabindex="8" name="telefon" class="form-control" placeholder="Estado: " id="inputDefault" value="">
		    </div>
	  </div>
	</div>
    <br>
  ...
  <input type="hidden" name="acceso" class="form-control"  id="inputDefault" value="100">
	<div class="float-end">		
	<a href="<?php echo RUTA_URL;?>/paginas/formsolicitud" class="btn btn-outline-warning">Atras</a>
    <!-- <a href="<?php echo RUTA_URL;?>/paginas/formsolicitud" class="btn btn-primary">Continuar</a> -->
		  <input type="submit" tabindex="9" class="btn btn-primary" value="Continuar">
	</div>
	</form>
</div>
