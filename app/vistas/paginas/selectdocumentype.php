...
<div class="container my-5">
  <h2 class="text-center">¿Tipo de documento a publicar?</h2>
</div>
        ...
        <div class="col-md-2 mt-3"></div>
          ...
          <div class="col-md-4 mt-3">
            <div class="card h-100">
              <div class="mx-2 card-body text-center">
                <br>
                <h4 class="card-title text-center mt-4 h-25">OFICIAL</h4>
                <i class="fa-regular fa-file iconos-tamanio"></i>
                <i class="fa-regular fa-file-pdf"></i>
                <br><br><br>
                <a href="<?php echo RUTA_URL;?>/paginas/selectOficial" class="btn btn-dark d-block mb-2 mt-3 text-capitalize">Seleccionar</a>
                </div>
            </div>
          </div>
          ...
          <div class="col-md-4 mt-3">
            <div class="card h-100">
              <div class="mx-2 card-body text-center">
                <br>
                <h4 class="card-title text-center mt-4 h-25">PARTICULAR</h4>
                <i class="fa-solid fa-file iconos-tamanio"></i>
                <i class="fa-solid fa-file-pdf"></i>
                <br><br><br>
                <a href="<?php echo RUTA_URL;?>/paginas/formordencompra" class="btn btn-dark d-block mb-2 mt-3 text-capitalize">Seleccionar</a>
              </div>
            </div>
          </div>
